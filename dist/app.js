...
(function($PS) {
  ...
  var renderHome = function (v) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column, Bulma_Common.unsafeClassName("is-8"), Bulma_Common.unsafeClassName("is-offset-2") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card article") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card-content") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media-content"), Bulma_Common.unsafeClassName("has-text-centered") ]) ])([ Halogen_HTML_Elements.p([ bulmaClass([ Bulma_Common.unsafeClassName("title"), Bulma_Common.unsafeClassName("article-title") ]) ])([ Halogen_HTML_Core.text("Test Post1") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card article") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card-content") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media-content"), Bulma_Common.unsafeClassName("has-text-centered") ]) ])([ Halogen_HTML_Elements.p([ bulmaClass([ Bulma_Common.unsafeClassName("title"), Bulma_Common.unsafeClassName("article-title") ]) ])([ Halogen_HTML_Core.text("Test Post2") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card article") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("card-content") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("media-content"), Bulma_Common.unsafeClassName("has-text-centered") ]) ])([ Halogen_HTML_Elements.p([ bulmaClass([ Bulma_Common.unsafeClassName("title"), Bulma_Common.unsafeClassName("article-title") ]) ])([ Halogen_HTML_Core.text("Test Post3") ]) ]) ]) ]) ]) ]);
  };
...
(function($PS) {
  ...
  var renderMenu = Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbar)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Layout_Layout.container)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarMenu)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarEnd)) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarItem)), Halogen_HTML_Properties.href("#home") ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarItem)), Halogen_HTML_Properties.href("#posts") ])([ Halogen_HTML_Core.text("Posts") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarItem)), Halogen_HTML_Properties.href("#profile") ])([ Halogen_HTML_Core.text("Profile") ]) ]) ]) ]) ]);
  ...
  var renderPane = function (state) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container ]) ])([ Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Common.unsafeClassName("articles") ]) ])([ (function () {
          ...
          throw new Error("Failed pattern match at Parent (line 129, column 43 - line 132, column 109): " + [ state.currentRoute.constructor.name ]);
      })() ]) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderMenu, renderSection, renderPane(state) ]);
  };

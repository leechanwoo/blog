...
(function($PS) {
  ...
  var renderMenu = Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbar)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Layout_Layout.container)) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("navbar-brand") ]) ])([ Halogen_HTML_Elements.span([ bulmaClass([ Bulma_Common.unsafeClassName("navbar-burger"), Bulma_Common.unsafeClassName("burger") ]), Halogen_HTML_Properties.attr("data-target")("navbarMenu") ])([ Halogen_HTML_Elements.span_([  ]), Halogen_HTML_Elements.span_([  ]), Halogen_HTML_Elements.span_([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("navbarMenu"), bulmaClass([ Bulma_Components_Navbar.navbarMenu ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarEnd)) ])([ Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem ]), Halogen_HTML_Properties.href("#home") ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem ]), Halogen_HTML_Properties.href("#posts") ])([ Halogen_HTML_Core.text("Posts") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem ]), Halogen_HTML_Properties.href("#profile") ])([ Halogen_HTML_Core.text("Profile") ]) ]) ]) ]) ]);
  ...
  var renderPane = function (state) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container ]) ])([ Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Common.unsafeClassName("articles") ]) ])([ (function () {
          ...
          throw new Error("Failed pattern match at Parent (line 145, column 43 - line 148, column 109): " + [ state.currentRoute.constructor.name ]);
      })() ]) ]);
  };

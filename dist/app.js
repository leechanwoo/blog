...
(function($PS) {
  ...
  var runClassNames = (function () {
      var $70 = Data_String_Common.joinWith(" ");
      var $71 = Data_Functor.map(Data_Functor.functorArray)(runClassName);
      return function ($72) {
          return $70($71($72));
      };
  })();
  ...
  var toClassName = (function () {
      var $73 = Data_Newtype.wrap(ntClassName);
      var $74 = Data_Newtype.unwrap(ntClassPart);
      return function ($75) {
          return $73($74($75));
      };
  })();
  ...
  var chIs = new ClassHelper(function (v) {
      ...
      throw new Error("Failed pattern match at Bulma.Common (line 78, column 1 - line 90, column 36): " + [ v.constructor.name ]);
  });
  var chColor = new ClassHelper(function (v) {
      ...
      throw new Error("Failed pattern match at Bulma.Common (line 104, column 1 - line 110, column 42): " + [ v.constructor.name ]);
  });  
  ...
  exports["unsafeClassName"] = unsafeClassName;
  exports["chIs"] = chIs;
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Columns.Columns"];
  var Bulma_Common = $PS["Bulma.Common"];             
  var isGapless = Bulma_Common.isClass("gapless");
  var columns = "columns";
  var column = "column";
  exports["columns"] = columns;
  exports["column"] = column;
  exports["isGapless"] = isGapless;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Bulma.Columns.Size"] = $PS["Bulma.Columns.Size"] || {};
  var exports = $PS["Bulma.Columns.Size"];
  var Bulma_Common = $PS["Bulma.Common"];
  var isOffsetClass = function (s) {
      return Bulma_Common.isClass(Bulma_Common.joinClassParts([ "offset", s ]));
  };
  var isOffset = (function () {
      var $3 = Bulma_Common.toClassPart(Bulma_Common.chIs);
      return function ($4) {
          return isOffsetClass($3($4));
      };
  })();
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Bulma.Components.Card"] = $PS["Bulma.Components.Card"] || {};
  var exports = $PS["Bulma.Components.Card"];
  var Bulma_Common = $PS["Bulma.Common"];
  var cardPart = "card";                                    
  var cardClass = function (cp) {
      return Bulma_Common.toClassName(Bulma_Common.joinClassParts([ cardPart, cp ]));
  };
  var cardContent = cardClass("content");
  var cardImage = cardClass("image");
  var card = Bulma_Common.toClassName(cardPart);
  exports["card"] = card;
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Components.Navbar"];
  var Bulma_Common = $PS["Bulma.Common"];
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Elements.Button"];
  var buttons = "buttons";
  var button = "button";
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Elements.Elements"];
  var content = "content";
  var box = "box";
  exports["box"] = box;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Bulma.Elements.Image"] = $PS["Bulma.Elements.Image"] || {};
  var exports = $PS["Bulma.Elements.Image"];
  var image = "image";
  exports["image"] = image;
})(PS);
(function($PS) {
  ...
  var exports = $PS["Bulma.Elements.Tag"];
  var tags = "tags";
  var tag = "tag";
  exports["tag"] = tag;
  exports["tags"] = tags;
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Elements.Title"];     
  var title = "title";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Bulma.Form.Common"] = $PS["Bulma.Form.Common"] || {};
  var exports = $PS["Bulma.Form.Common"];
  var isRounded = "is-rounded";
  exports["isRounded"] = isRounded;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Bulma.Layout.Layout"] = $PS["Bulma.Layout.Layout"] || {};
  var exports = $PS["Bulma.Layout.Layout"];
  var Bulma_Common = $PS["Bulma.Common"];
  var section = "section";
  var mediaPart = "media";
  var mediaClass = function (cp) {
      return Bulma_Common.toClassName(Bulma_Common.joinClassParts([ mediaPart, cp ]));
  };
  var mediaContent = mediaClass("content");
  var media = Bulma_Common.toClassName(mediaPart);
  var levelPart = "level";
  var levelClass = function (cp) {
      return Bulma_Common.toClassName(Bulma_Common.joinClassParts([ levelPart, cp ]));
  };
  var levelItem = levelClass("item");         
  var isBold = Bulma_Common.isClass("bold");
  var heroPart = "hero";
...
(function($PS) {
  ...
  var exports = $PS["Bulma.Modifiers.Typography"];
  var Bulma_Common = $PS["Bulma.Common"];
  ...
  var chColor = new Bulma_Common.ClassHelper(function (v) {
      ...
      throw new Error("Failed pattern match at Bulma.Modifiers.Typography (line 75, column 1 - line 91, column 47): " + [ v.constructor.name ]);
  });
  var hasColor = (function () {
      var $19 = Bulma_Common.toClassPart(chColor);
      return function ($20) {
          return hasTextClass($19($20));
      };
  })();
  var chAlignment = new Bulma_Common.ClassHelper(function (v) {
      ...
      throw new Error("Failed pattern match at Bulma.Modifiers.Typography (line 104, column 1 - line 108, column 40): " + [ v.constructor.name ]);
  });
  var hasAlignment = (function () {
      var $21 = Bulma_Common.toClassPart(chAlignment);
      return function ($22) {
          return hasTextClass($21($22));
      };
  })();
...
(function($PS) {
  ...
  var testPost1 = (function () {
      var content = [ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("This is a test contents. I'm happy to create my own blog"), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("This is very meaningful to me."), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("Here is for introducing algorithms about machine learning and functional programming. these thems are very important to follow the trand of tech."), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("I'll try to share much useful information "), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("Thank you very much") ]) ];
      return {
          title: "This is title of test post1",
          date: "March 7, 2020",
          tag: "purescript",
  ...
  var renderCard = function (v) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.card, Bulma_Common.unsafeClassName("article") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.cardContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.p([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("article-title"), Bulma_Modifiers_Typography.hasAlignment(Bulma_Modifiers_Typography.Centered.value) ]) ])([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Tag.tags, Bulma_Common.hasAddons, Bulma_Layout_Layout.levelItem ]) ])([ Halogen_HTML_Elements.span([ bulmaClass([ Bulma_Elements_Tag.tag, Bulma_Form_Common.isRounded, Bulma_Common.unsafeClassName("is-info") ]) ])([ Halogen_HTML_Core.text(v.tag) ]), Halogen_HTML_Elements.span([ bulmaClass([ Bulma_Elements_Tag.tag, Bulma_Form_Common.isRounded ]) ])([ Halogen_HTML_Core.text(v.date) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content, Bulma_Common.unsafeClassName("article-body") ]) ])(v.content) ]) ]) ]) ]);
  };
  var renderHome = function (v) {
      return Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Common.unsafeClassName("section-heading") ]) ])([ Halogen_HTML_Elements.h2([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-1"), Bulma_Modifiers_Typography.hasColor(Bulma_Modifiers_Typography.White.value), Bulma_Modifiers_Typography.hasAlignment(Bulma_Modifiers_Typography.Centered.value) ]) ])([ Halogen_HTML_Core.text("Welcome to Chanwoo's blog") ]), Halogen_HTML_Elements.h3([ bulmaClass([ Bulma_Elements_Title.subtitle, Bulma_Common.unsafeClassName("is-3"), Bulma_Modifiers_Typography.hasColor(Bulma_Modifiers_Typography.White.value), Bulma_Modifiers_Typography.hasAlignment(Bulma_Modifiers_Typography.Centered.value) ]) ])([ Halogen_HTML_Core.text("Blog constructing in progress") ]) ]);
  };
  ...
  var renderPosts = function (v) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column, Bulma_Common.unsafeClassName("is-10"), Bulma_Columns_Size.isOffset(Bulma_Common.Is1.value) ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderCard)([ testPost1, testPost2 ]));
  };
  ...
  var renderProfile = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Common.unsafeClassName("section-heading") ]) ])([ Halogen_HTML_Elements.h1([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-1"), Bulma_Modifiers_Typography.hasColor(Bulma_Modifiers_Typography.White.value), Bulma_Modifiers_Typography.hasAlignment(Bulma_Modifiers_Typography.Centered.value) ]) ])([ Halogen_HTML_Core.text("Lee Chanwoo") ]), Halogen_HTML_Elements.h2([ bulmaClass([ Bulma_Elements_Title.subtitle, Bulma_Common.unsafeClassName("is-3"), Bulma_Modifiers_Typography.hasColor(Bulma_Modifiers_Typography.White.value), Bulma_Modifiers_Typography.hasAlignment(Bulma_Modifiers_Typography.Centered.value) ]) ])([ Halogen_HTML_Core.text("Mathmatic Programmer") ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.id_("about"), bulmaClass([ Bulma_Layout_Layout.section, Bulma_Common.unsafeClassName("section-padding-large") ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("section-heading") ]) ])([ Halogen_HTML_Elements.h3([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-2") ]) ])([ Halogen_HTML_Core.text("About Me") ]), Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.subtitle, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("Tech All Rounder") ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("I'm the all rounder of development, system design etc.") ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.columns, Bulma_Common.unsafeClassName("has-same-height"), Bulma_Columns_Columns.isGapless ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.card ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.cardContent ]) ])([ Halogen_HTML_Elements.h3([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-4") ]) ])([ Halogen_HTML_Core.text("Profile") ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.table([ bulmaClass([ Bulma_Common.unsafeClassName("table-profile") ]) ])([ Halogen_HTML_Elements.tbody_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th([ Halogen_HTML_Properties.colSpan(1) ])([  ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.colSpan(2) ])([  ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("Address:") ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("Guru's Lab") ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("Phone:") ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("0123-456789") ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("Email:") ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("minion@despicable.me") ]) ]) ]) ]) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Button.buttons ]) ])([ Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Elements_Button.button ]) ])([ Halogen_HTML_Core.text("Github") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Elements_Button.button ]) ])([ Halogen_HTML_Core.text("LinkedIn") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Elements_Button.button ]) ])([ Halogen_HTML_Core.text("Twitter") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.card ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.cardImage ]) ])([ Halogen_HTML_Elements.figure([ bulmaClass([ Bulma_Elements_Image.image, Bulma_Common.unsafeClassName("is-4by3") ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("https://source.unsplash.com/random/1280x960"), Halogen_HTML_Properties.alt("Placeholder image") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.card ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Components_Card.cardContent, Bulma_Common.unsafeClassName("skills-content") ]) ])([ Halogen_HTML_Elements.h3([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-4") ]) ])([ Halogen_HTML_Core.text("Skills") ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.article([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("JavaScript") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.progress([ bulmaClass([ Bulma_Common.unsafeClassName("progress"), Bulma_Common.unsafeClassName("is-primary") ]), Halogen_HTML_Properties.attr("value")("90"), Halogen_HTML_Properties.attr("max")("100") ])([  ]) ]) ]) ]) ]), Halogen_HTML_Elements.article([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("JavaScript") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.progress([ bulmaClass([ Bulma_Common.unsafeClassName("progress"), Bulma_Common.unsafeClassName("is-primary") ]), Halogen_HTML_Properties.attr("value")("90"), Halogen_HTML_Properties.attr("max")("100") ])([  ]) ]) ]) ]) ]), Halogen_HTML_Elements.article([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("JavaScript") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.progress([ bulmaClass([ Bulma_Common.unsafeClassName("progress"), Bulma_Common.unsafeClassName("is-primary") ]), Halogen_HTML_Properties.attr("value")("90"), Halogen_HTML_Properties.attr("max")("100") ])([  ]) ]) ]) ]) ]), Halogen_HTML_Elements.article([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("JavaScript") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.progress([ bulmaClass([ Bulma_Common.unsafeClassName("progress"), Bulma_Common.unsafeClassName("is-primary") ]), Halogen_HTML_Properties.attr("value")("90"), Halogen_HTML_Properties.attr("max")("100") ])([  ]) ]) ]) ]) ]), Halogen_HTML_Elements.article([ bulmaClass([ Bulma_Layout_Layout.media ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.mediaContent ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("JavaScript") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.progress([ bulmaClass([ Bulma_Common.unsafeClassName("progress"), Bulma_Common.unsafeClassName("is-primary") ]), Halogen_HTML_Properties.attr("value")("90"), Halogen_HTML_Properties.attr("max")("100") ])([  ]) ]) ]) ]) ]) ]) ]) ]) ]) ]) ]), Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Layout_Layout.section ]), Halogen_HTML_Properties.id_("service") ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("section-heading") ]) ])([ Halogen_HTML_Elements.h3([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-2") ]) ])([ Halogen_HTML_Core.text("Serivce") ]), Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.subtitle, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("What can I do for you?") ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.columns ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.box ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("Front End Web Developer") ]), Halogen_HTML_Core.text("Develop Front End using latest standards with HTML5/CSS3 with added funtionality using JavaScript and Vue.js.") ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.box ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("Front End Web Developer") ]), Halogen_HTML_Core.text("Develop Front End using latest standards with HTML5/CSS3 with added funtionality using JavaScript and Vue.js.") ]) ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.columns ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.box ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("Front End Web Developer") ]), Halogen_HTML_Core.text("Develop Front End using latest standards with HTML5/CSS3 with added funtionality using JavaScript and Vue.js.") ]) ]) ]), Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Columns_Columns.column ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.box ]) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Elements_Elements.content ]) ])([ Halogen_HTML_Elements.h4([ bulmaClass([ Bulma_Elements_Title.title, Bulma_Common.unsafeClassName("is-5") ]) ])([ Halogen_HTML_Core.text("Front End Web Developer") ]), Halogen_HTML_Core.text("Develop Front End using latest standards with HTML5/CSS3 with added funtionality using JavaScript and Vue.js.") ]) ]) ]) ]) ]) ]) ]);
  };
...
(function($PS) {
  ...
  var getRoute = function __do() {
      ...
      if (hash === "#posts") {
          return new Data_Maybe.Just(Posts.value);
      };
      if (hash === "#profile") {
  ...
  var router = function (cb) {
      var matchRoute = function __do() {
          var route = getRoute();
          if (route instanceof Data_Maybe.Just) {
              return cb(route.value0)();
          };
          if (route instanceof Data_Maybe.Nothing) {
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at Router (line 26, column 14 - line 28, column 39): " + [ route.constructor.name ]);
      };
      return function __do() {
          var listener = Web_Event_EventTarget.eventListener(Data_Function["const"](matchRoute))();
          var window$prime = Web_HTML.window();
          return Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(listener)(false)(Web_HTML_Window.toEventTarget(window$prime))();
      };
  };
  exports["Home"] = Home;
  exports["Posts"] = Posts;
...
(function($PS) {
  ...
  var BurgerToggle = (function () {
      function BurgerToggle(value0) {
          this.value0 = value0;
      };
      BurgerToggle.create = function (value0) {
          return new BurgerToggle(value0);
      };
      return BurgerToggle;
  })();
  var toHClassName = function (v) {
      return v;
  };
  ...
  var bulmaClass = function ($21) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(Bulma_Common.runClassNames($21)));
  };
  var renderMenu = function (state) {
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbar)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Layout_Layout.container)) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Common.unsafeClassName("navbar-brand") ]) ])([ Halogen_HTML_Elements.span([ bulmaClass([ Bulma_Common.unsafeClassName("navbar-burger"), Bulma_Common.unsafeClassName("burger"), Bulma_Common.unsafeClassName((function () {
          if (state.burger) {
              return "is-active";
          };
          return "";
      })()) ]), Halogen_HTML_Properties.attr("data-target")("navbarMenu"), Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(new BurgerToggle(state.burger)))) ])([ Halogen_HTML_Elements.span_([  ]), Halogen_HTML_Elements.span_([  ]), Halogen_HTML_Elements.span_([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("navbarMenu"), bulmaClass([ Bulma_Components_Navbar.navbarMenu, Bulma_Common.unsafeClassName((function () {
          if (state.burger) {
              return "is-active";
          };
          return "";
      })()) ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Components_Navbar.navbarEnd)) ])([ Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem, Bulma_Common.unsafeClassName("is-active") ]), Halogen_HTML_Properties.href("#home") ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem ]), Halogen_HTML_Properties.href("#posts") ])([ Halogen_HTML_Core.text("Posts") ]), Halogen_HTML_Elements.a([ bulmaClass([ Bulma_Components_Navbar.navbarItem ]), Halogen_HTML_Properties.href("#profile") ])([ Halogen_HTML_Core.text("Profile") ]) ]) ]) ]) ]);
  };
  var renderSection = Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Layout_Layout.hero, Bulma_Layout_Layout.isBold, Bulma_Common.unsafeClassName("is-info"), Bulma_Common.unsafeClassName("is-medium") ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Layout_Layout.heroBody)) ])([ Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container, Bulma_Common.unsafeClassName("has-text-centered") ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_(toHClassName(Bulma_Elements_Title.title)) ])([ Halogen_HTML_Core.text("Beautiful Programming") ]) ]) ]) ]);
  var _profile = Data_Symbol.SProxy.value;
  var _posts = Data_Symbol.SProxy.value;
  var _home = Data_Symbol.SProxy.value;
  var renderPane = function (state) {
      return Halogen_HTML_Elements.div([ bulmaClass([ Bulma_Layout_Layout.container ]) ])([ Halogen_HTML_Elements.section([ bulmaClass([ Bulma_Common.unsafeClassName("articles") ]) ])([ (function () {
          if (state.currentRoute instanceof Router.Home) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "home";
              }))(Data_Ord.ordUnit)(_home)(Data_Unit.unit)(Children.home)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Posts) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "posts";
              }))(Data_Ord.ordUnit)(_posts)(Data_Unit.unit)(Children.posts)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Profile) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "profile";
              }))(Data_Ord.ordUnit)(_profile)(Data_Unit.unit)(Children.profile)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Parent (line 165, column 43 - line 168, column 109): " + [ state.currentRoute.constructor.name ]);
      })() ]) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderMenu(state), renderSection, renderPane(state) ]);
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Router.Home.value))(Router.getRoute)))(function (current) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Parent.page)(current)(body))(function (io) {
              ...
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Router.router(changeRoute));
          });
      });
  }));
  exports["main"] = main;

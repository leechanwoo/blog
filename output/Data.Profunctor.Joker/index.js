...
var bindJoker = function (dictBind) {
    return new Control_Bind.Bind(function () {
        ...
        return function (amb) {
            return Joker(Control_Bind.bind(dictBind)(v)(function ($36) {
                return Data_Newtype.un(newtypeJoker)(Joker)(amb($36));
            }));
        };
    });
};
var applicativeJoker = function (dictApplicative) {
    return new Control_Applicative.Applicative(function () {
        ...
        return Joker(Control_Applicative.pure(dictApplicative)($37));
    });
};

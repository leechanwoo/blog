...
var fromEnumReadyState = function (v) {
    ...
    throw new Error("Failed pattern match at Web.File.FileReader.ReadyState (line 43, column 3 - line 46, column 13): " + [ v.constructor.name ]);
};
...
var ordReadyState = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Web.File.FileReader.ReadyState (line 13, column 8 - line 13, column 48): " + [ x.constructor.name, y.constructor.name ]);
    };
});
